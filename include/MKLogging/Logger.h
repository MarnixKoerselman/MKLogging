...
#ifndef MKL_LOGD
#define MKL_LOGD(mp_Logger, mp_Out) do { if (MKL_ISLOGGED(mp_Logger, MKLogging::ELogLevel::Debug)) { MKLogging::LogRecordAutoSink(mp_Logger, MKLogging::ELogLevel::Debug, __FUNCTION__, __FILE__, __LINE__).Get() << mp_Out << MKL_ENDLINE; } } while (0)
#endif

#ifndef MKL_LOGI
#define MKL_LOGI(mp_Logger, mp_Out) do { if (MKL_ISLOGGED(mp_Logger, MKLogging::ELogLevel::Info)) { MKLogging::LogRecordAutoSink(mp_Logger, MKLogging::ELogLevel::Info, __FUNCTION__, __FILE__, __LINE__).Get() << mp_Out << MKL_ENDLINE; } } while (0)
#endif

#ifndef MKL_LOGW
#define MKL_LOGW(mp_Logger, mp_Out) do { if (MKL_ISLOGGED(mp_Logger, MKLogging::ELogLevel::Warning)) { MKLogging::LogRecordAutoSink(mp_Logger, MKLogging::ELogLevel::Warning, __FUNCTION__, __FILE__, __LINE__).Get() << mp_Out << MKL_ENDLINE; } } while (0)
#endif

#ifndef MKL_LOGE
#define MKL_LOGE(mp_Logger, mp_Out) do { if (MKL_ISLOGGED(mp_Logger, MKLogging::ELogLevel::Error)) { MKLogging::LogRecordAutoSink(mp_Logger, MKLogging::ELogLevel::Error, __FUNCTION__, __FILE__, __LINE__).Get() << mp_Out << MKL_ENDLINE; } } while (0)
#endif
