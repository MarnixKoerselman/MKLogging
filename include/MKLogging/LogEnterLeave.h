...
#else
#define MKL_LOG_ENTER_LEAVE(mp_Logger, mp_LogLevel) MKLogging::LogEnterLeave mgen_LogEnterLeave(mp_Logger, mp_LogLevel, __FILE__, __LINE__, __FUNCTION__);
...
namespace MKLogging
{
  ...
  public:
    ...
    LogEnterLeave(Logger* logger, ELogLevel logLevel, const char* file, int line, const char* function);
#if __cplusplus >= 202002L
